...
parser.add_argument("--nt_val", type=int, default=2, help="number of time steps for validation")
...
parser.add_argument("--drop_freq"   , type=int  , default=50, help="how often to decrease learning rate")
parser.add_argument('--weight_decay', type=float, default=0.0)
parser.add_argument('--lr_drop'     , type=float, default=1.000001)
    ...
    for itr in range(0, args.niters + 1):
        ...
        if itr == args.niters:
            ...
            with torch.no_grad():
                ...
                x0val,rhoval = toy_data.inf_train_gen(args.data, batch_size=5000)
                x0val  = cvt(torch.from_numpy(x0val))
